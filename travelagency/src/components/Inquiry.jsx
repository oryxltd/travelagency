...
function Inquiry() {
    ...
    switch (destination) {
      ...
      case "Bandhavgarh":
        return [
          ...
          "Magdhi Zone",
          "Khitauli Zone",
          "Buffer Zone (Dhamokhar Zone, Johila Zone, Panpatha Zone, Manpur Zone, Pachpedi Zone)",
        ];
      case "Pench":
        return ["Madhya Pradesh Side", "Maharashtra Side"];
      case "Panna":
        return [
          "Core Zone (Panna National Park)",
          "Buffer Zones (Ken Gharial Wildlife Sanctuary, North and South Panna Forest Divisions)",
        ];
      default:
        return [];
    }
  ...
  // set specific timing for each zones
  const getShiftOptions = () => {
    if (zone) {
      switch (zone) {
        ...
        case "Madhya Pradesh Side":
        case "Maharashtra Side":
        case "Core Zone (Panna National Park)":
        case "Buffer Zones (Ken Gharial Wildlife Sanctuary, North and South Panna Forest Divisions)":
        case "Buffer Zone (Dhamokhar Zone, Johila Zone, Panpatha Zone, Manpur Zone, Pachpedi Zone)":
        case "Buffer Zone (Dhamokhar, Johila, Panpatha, Manpur, Pachpedi)":
        case "Kanha Zone":
        case "Kisli Zone":
        case "Mukki Zone":
        case "Sarahi Zone":
        case "Buffer Zone":
          return ["Morning", "Afternoon", "Evening"]; // Example default for other zones
        default:
          return [];
      }
    }
